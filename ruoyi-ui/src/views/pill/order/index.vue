  ...
  methods: {
    ...
    getList() {
      ...
      listOrder(this.queryParams).then(response => {
        ...
        // 🔍 调试代码 - 查看后端返回的数据
        console.log('=== 订单数据调试 ===');
        console.log('字典配置:', this.dict.type.pill_order_status);
        console.log('订单列表数据:', this.orderList);

        if (this.orderList.length > 0) {
          console.log('第一条订单详情:', this.orderList[0]);
          console.log('状态字段值:', this.orderList[0].status);
          console.log('状态字段类型:', typeof this.orderList[0].status);
        }
      }).catch(error => {
